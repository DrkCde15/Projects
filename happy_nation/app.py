...
diretorio = 'C:/Users/Júlio César/Documents/Projects/happy_nation'
...
def salvar_dados_em_txt(dados):
    try:
        ...
        with open(arquivo_path, "a", encoding="utf-8") as f:  # "a" para adicionar novas linhas sem sobrescrever
            f.write(dados + "\n")
